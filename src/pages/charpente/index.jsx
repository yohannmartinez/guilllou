...
const Charpente = () => {
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>Guillou Couverture - Charpente</title>
        <meta
          name="description"
          content="Un projet de charpente ? Notre société met à votre service son experience de plus de 20 ans autour de Saint-nom-la-breteche et dans le 78"
        />
